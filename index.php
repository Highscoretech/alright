		...
		<div class="row">
               ...
               <div class="col-md-6 col-sm-7 col-xs-12">
                    <div class="home-thumb">
                         <h1 class="wow fadeInUp" data-wow-delay="0.6s">Rosnac company</h1>
                         <p class="wow fadeInUp" data-wow-delay="0.8s">Rosnac is a cryptoeconomic friendly online advertising corporation for capitalist, affiliates ad networks and publishers.</p>
                         <a href="reg.php" class="wow fadeInUp section-btn btn btn-success smoothScroll" data-wow-delay="1s">Get started</a>
                    </div>
               </div>
          ...
          <div class="row">
               ...
               <div class="col-md-12 col-sm-12">
                    <div class="wow bounceIn section-title">
                         <h1>welcome to rosnac investment company</h1>
                         <hr>
                    </div>
               </div>
