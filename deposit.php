            ...
            <div class="inner-block">
                ...
                <p>Your payment_ID will be sent to the above email</p>
                    ...
                    <select class="form-select" aria-label="Default select example>" name="plan" required>
                        <option >Select your favourite plan </option>
                        <option value="1">Silver plan => $10 </option>
                        <option value="2">Pearl plan => $20 </option>
                        <option value="3">Red corol plan => $50</option>
                        <option value="4">Tanzanite => $100</option>
                        <option value="5">Sapphire => $250</option>
                        <option value="6">Opal plan => $500</option>
                        <option value="7">Black_diamond => $1000</option>
                        <option value="8">Benitoite plan => $2000</option>
                        <option value="9">Rubby plan => $3000</option>
...
paidbtn.addEventListener("click", function(){
    ...
    <p id="p1"> bc1q0ysmgl566ph4p5xvyy9kmfrfq74s97edn5xehk</p>  
    ...
    <div class="payment-address">
        ...
        <p id="p2">LWmvgHNMym8hkFHe4rZ3kioRH4Y3VqBvPU </p>
    </div>
    ...
    <p id="p3">TT1PFyJx9SiSG8nGEYgnfRj3zPR1exGZ21
    </p>
    </div>
<!-- 
    <div class="payment-address">
